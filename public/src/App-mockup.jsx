...
// const MOCK_BASE64_IMAGE = "iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==";

// let mockTicketReplies = {
//     2: [
//         { replyid: 1, userid: 1001, role: 'Manager', message: 'Thank you for reaching out. We are looking into this service approval delay and will get back to you shortly.', created_at: '2025-06-18T14:05:00Z' },
//         { replyid: 2, userid: 1001, role: 'Manager', message: 'It appears there was an issue with the initial review. We have re-queued your service for immediate approval.', created_at: '2025-06-18T14:20:00Z' },
//     ]
// };

// let mockPets = [
//     { petid: 1, userid: 1, name: "Buddy", breed: "Golden Retriever", age: 5, dob: "2020-05-15", description: "Loves to play fetch and swim.", picture: "https://placehold.co/400x400/f8b400/ffffff?text=Buddy", weight: "30kg" },
//     { petid: 2, userid: 1, name: "Lucy", breed: "Siamese Cat", age: 3, dob: "2022-01-20", description: "A very vocal and affectionate cat.", picture: "https://placehold.co/400x400/a0d2eb/ffffff?text=Lucy", weight: "5kg" },
//     { petid: 3, userid: 2, name: "Rocky", breed: "German Shepherd", age: 4, dob: "2021-03-10", description: "Loves long runs.", picture: "https://placehold.co/400x400/cdb4db/ffffff?text=Rocky", weight: "35kg" },
// ];

// let mockDiets = {
//     1: [{id: 1, petid: 1, food_name: "Morning Kibble", quantity: "2 cups", hour: "08", minute: "00", description: "With a splash of water.", startdate: "2025-01-01", enddate: "2025-12-31", repeat_option: "daily", addToCalendar: true}],
//     2: [{id: 2, petid: 2, food_name: "Evening Wet Food", quantity: "1 can", hour: "18", minute: "30", description: "", startdate: "2025-01-01", enddate: null, repeat_option: "daily", addToCalendar: true}]
// };

// let mockActivities = {
//     1: [{id: 1, petid: 1, activity_name: "Park Walk", date: "2025-06-23", time: "07:00", duration: "30 minutes", notes: "Energetic walk in the park", startdate: "2025-06-23", enddate: null, repeat_option: "none", addToCalendar: true}],
//     2: []
// }

// let mockServices = [
//     { serviceid: 1, name: "Premium Dog Walking", price: 25, description: "A 60-minute walk in the park for energetic dogs.", duration: "60 minutes", typeid: 1, service_type: "Walking", providerid: 101, provider_name: "Happy Paws Co.", website: "https://happypaws.example.com", license: "LIC12345", address: "123 Park Ave, New York, NY", phone: "555-0101", timeslots: ['09:00', '10:00', '11:00', '14:00', '15:00'], status: 'approved' },
//     { serviceid: 2, name: "Cat Sitting (Basic)", price: 20, description: "Daily visit for feeding, water, and litter box cleaning.", duration: "30 minutes", typeid: 2, service_type: "Sitting", providerid: 102, provider_name: "Purrfect Sitters", website: null, license: "LIC67890", address: "456 Main St, Anytown, USA", phone: "555-0102", timeslots: ['08:00', '12:00', '18:00'], status: 'approved' },
//     { serviceid: 3, name: "Full-Day Doggy Daycare", price: 40, description: "A full day of supervised play and socialization.", duration: "8 hours", typeid: 3, service_type: "Daycare", providerid: 101, provider_name: "Happy Paws Co.", website: "https://happypaws.example.com", license: "LIC12345", address: "123 Park Ave, New York, NY", phone: "555-0101", timeslots: ['08:00', '09:00'], status: 'approved' },
//     { serviceid: 4, name: "Advanced Obedience Training", price: 150, description: "5-week course covering advanced commands and behaviors.", duration: "5 sessions", typeid: 4, service_type: "Training", providerid: 103, provider_name: "Smart Pups Academy", website: "https://smartpups.example.com", license: "LIC54321", address: "789 School Rd, Education City", phone: "555-0103", timeslots: ['18:00', '19:00'], status: 'approved' },
//     { serviceid: 5, name: "Professional Dog Grooming", price: 75, description: "Includes bath, haircut, nail trim, and ear cleaning.", duration: "2 hours", typeid: 5, service_type: "Grooming", providerid: 104, provider_name: "Glamour Paws", website: "https://glamourpaws.example.com", license: "LIC98765", address: "101 Style St, Fashion City", phone: "555-0104", timeslots: ['10:00', '13:00', '15:00'], status: 'approved' },

//     { serviceid: 6, name: "Advanced Obedience Training", price: 150, description: "5-week course covering advanced commands and behaviors.", duration: "5 sessions", typeid: 4, service_type: "Training", providerid: 103, provider_name: "Smart Pups Academy", website: "https://smartpups.example.com", license: "LIC54321", address: "789 School Rd, Education City", phone: "555-0103", timeslots: ['18:00', '19:00'] },
//     { serviceid: 7, name: "Professional Dog Grooming", price: 75, description: "Includes bath, haircut, nail trim, and ear cleaning.", duration: "2 hours", typeid: 5, service_type: "Grooming", providerid: 104, provider_name: "Glamour Paws", website: "https://glamourpaws.example.com", license: "LIC98765", address: "101 Style St, Fashion City", phone: "555-0104", timeslots: ['10:00', '13:00', '15:00']},
// ];
...
// let mockBookings = [
//     { bookid: 1, userid: 1, serviceid: 1, servedate: "2025-07-15", slot: "10:00", status: "confirmed", pets: [mockPets[0]]},
//     { bookid: 2, userid: 1, serviceid: 3, servedate: "2025-06-18", slot: "09:00", status: "completed", pets: [mockPets[0]]},
//     { bookid: 3, userid: 1, serviceid: 2, servedate: "2025-07-20", slot: "14:00", status: "pending", pets: [mockPets[1]] },
//     { bookid: 5, userid: 1, serviceid: 5, servedate: getCurrentDate(), slot: "11:00", status: "in-progress", pets: [mockPets[1]]}
// ];

// const mockChatUpdates = {
//     5: [
//         { no_update: 1, from: 'provider', text: "Lucy is all checked in and doing great!", timestamp: "11:05 AM" },
//         { no_update: 2, from: 'provider', hasImage: true, timestamp: "11:25 AM" },
//         { no_update: 3, from: 'owner', text: "Thanks for the update! She looks so calm.", timestamp: "11:26 AM" },
//         { no_update: 4, from: 'provider', text: "Bath time! She's enjoying the bubbles.", timestamp: "11:45 AM" },
//         { no_update: 5, from: 'provider', hasImage: true, timestamp: "11:46 AM" },
//     ]
// };

// let mockReviews = [
//     { id: 1, userid: 2, serviceid: 1, reviewer_name: "Sarah K.", date: "2025-06-20", stars: 5, comment: "Happy Paws Co. is the best! My dog, Max, always comes back happy and tired. Highly recommend their walking services." },
//     { id: 2, userid: 3, serviceid: 1, reviewer_name: "Mike L.", date: "2025-06-15", stars: 4, comment: "Great service, very reliable. My only wish is that they provided more photos during the walk. Otherwise, fantastic!" },
//     { id: 3, userid: 4, serviceid: 5, reviewer_name: "Jessica P.", date: "2025-06-12", stars: 5, comment: "Glamour Paws did an amazing job with my poodle. The haircut was perfect and he smells wonderful. We will be back!" },
// ];

// let mockProviderRequests = [
//     { bookid: 3, servedate: "2025-07-22", slot: "14:00", status: "pending", service_name: "Cat Sitting (Basic)", pet_owner_name: "Alex Johnson", pets: [mockPets[1]] },
//     { bookid: 4, servedate: "2025-07-24", slot: "11:00", status: "pending", service_name: "Professional Dog Grooming", pet_owner_name: "Jane Smith", pets: [mockPets[2]] },
// ];

// let mockOwnerProfile = {
//     id: 1, name: 'Alex Johnson', email: 'owner@test.com', role: 'Pet owner', phone: '555-123-4567', address: '123 Pet Lane, Dogtown, USA', city: 'Dogtown', gender: 'Other'
// };

// let mockProviderProfile = {
//     id: 101, name: 'Happy Paws Co.', email: 'provider@test.com', role: 'Service provider', phone: '555-0101',
//     address: '123 Park Ave, New York, NY', city: 'New York', gender: 'N/A',
//     business_name: 'Happy Paws Co.', license: 'LIC12345', website: 'https://happypaws.example.com', description: 'Providing top-notch walking and daycare services since 2018.',
//     logo: { type: 'Buffer', data: [137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0, 5, 0, 0, 0, 5, 8, 6, 0, 0, 0, 205, 126, 248, 155, 0, 0, 0, 7, 116, 73, 77, 69, 1, 1, 0, 48, 12, 4, 3, 0, 172, 23, 222, 102] }, // Simulated buffer data
//     joinedDate: "2021-08-15T14:30:00Z"
// };

// let mockTickets = [
//     { id: 1, subject: 'Payment issue with last booking', description: 'Hello, I was charged twice for my last booking (ID: 2). Please investigate.', status: 'open', date: '2025-06-20T10:00:00Z', userId: 1, userName: 'Alex Johnson', userRole: 'Pet owner' },
//     { id: 2, subject: 'Question about service approval', description: 'How long does it usually take for a new service to be approved by the management?', status: 'resolved', date: '2025-06-18T14:00:00Z', userId: 101, userName: 'Happy Paws Co.', userRole: 'Service provider' },
// ];

// let mockNotifications = [
//     // === Pet Owner Notifications ===
//     { notiid: 1, userid: 1, text: 'Your booking for "Premium Dog Walking" was confirmed!', type: 'booking_accepted', created_at: new Date(Date.now() - 3600000).toISOString(), read_status: 0, targetId: 1 },
//     { notiid: 2, userid: 1, text: 'Time to feed Lucy! Diet: Evening Wet Food (1 can)', type: 'diet', created_at: new Date(Date.now() - 7200000).toISOString(), read_status: 0, targetId: 2 },
//     { notiid: 5, userid: 1, text: 'Time for Buddy\'s activity: Park Walk', type: 'activity', created_at: new Date(Date.now() - 3600000 * 6).toISOString(), read_status: 0, targetId: 1 },
//     { notiid: 7, userid: 1, text: 'Your password was recently changed.', type: 'general', created_at: new Date(Date.now() - 3600000 * 24).toISOString(), read_status: 1, targetId: null },
//     { notiid: 8, userid: 1, text: 'A provider sent you a message regarding "Professional Dog Grooming".', type: 'chat', created_at: new Date(Date.now() - 120000).toISOString(), read_status: 0, targetId: 5 },


//     // === Service Provider Notifications ===
//     { notiid: 3, userid: 101, text: 'Your service "Advanced Obedience Training" has been approved!', type: 'service_approved', created_at: new Date(Date.now() - 86400000).toISOString(), read_status: 1, targetId: 4 },
//     { notiid: 4, userid: 101, text: 'New booking request from Sarah K. for "Full-Day Doggy Daycare"', type: 'booking_request', created_at: new Date(Date.now() - 172800000).toISOString(), read_status: 1, targetId: 1 },
//     { notiid: 6, userid: 101, text: 'A new review was posted for your "Dog Walking" service.', type: 'review', created_at: new Date(Date.now() - 3600000 * 8).toISOString(), read_status: 0, targetId: 1 },
//     { notiid: 9, userid: 101, text: 'Your service "Exotic Bird Boarding" was rejected.', type: 'service_rejected', created_at: new Date(Date.now() - 3600000 * 4).toISOString(), read_status: 0, targetId: 7 },


//     // === Manager Notifications ===
//     { notiid: 10, userid: 1001, text: 'A new service "Agility Training" requires your approval.', type: 'service_pending', created_at: new Date(Date.now() - 3600000 * 2).toISOString(), read_status: 0, targetId: 10 },
//     { notiid: 11, userid: 1001, text: 'A new support ticket has been opened by Alex Johnson.', type: 'ticket_new', created_at: new Date(Date.now() - 3600000 * 5).toISOString(), read_status: 0, targetId: 1 },
//     { notiid: 12, userid: 1001, text: 'A user report has been filed against "Happy Paws Co.". ', type: 'report', created_at: new Date(Date.now() - 3600000 * 10).toISOString(), read_status: 1, targetId: 2 },
// ];

// let mockServiceTypes = [
//     { typeid: 1, type: "Walking" },
//     { typeid: 2, type: "Sitting" },
//     { typeid: 3, type: "Daycare" },
//     { typeid: 4, type: "Training" },
//     { typeid: 5, type: "Grooming" },
// ];

// let mockReports = [
//     { bookid: 2, service_name: "Full-Day Doggy Daycare", provider_name: "Happy Paws Co.", text: "My dog seemed very thirsty when I picked him up. I'm not sure if water was readily available all day.", image: null, servedate: "2025-06-18", reporter_name: "Alex Johnson" },
//     { bookid: 99, service_name: "Premium Dog Walking", provider_name: "Happy Paws Co.", text: "The walker was 15 minutes late starting the walk.", image: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUA', servedate: "2025-06-10", reporter_name: "Jane Smith" },
// ];

// const mockProviderDashboard = {
//     workAppointments: mockProviderRequests.map(b => ({...b, pets: b.pets.map(p => p.name).join(', ')})),
//     statistics: {
//         totalAppointments: 8,
...
//         totalRevenue: 350.50,
//         serviceBreakdown: {
//             "Dog Walking": { count: 4, revenue: 100 },
//             "Pet Sitting": { count: 2, revenue: 80 },
//             "Grooming": { count: 2, revenue: 170.50 },
//         },
//         pendingRequests: mockProviderRequests.filter(r => r.status === 'pending').length,
//         activeServices: mockServices.filter(s => s.providerid === 101 && s.status === 'approved').length,
//     }
// };

// const mockScheduleDashboard = {
//     appointments: [
//         { bookid: 1, servedate: "2025-07-15", slot: "10:00", status: "confirmed", service_name: "Premium Dog Walking", provider_name: "Happy Paws Co.", price: 25, pets: [mockPets[0]]},
//         { bookid: 2, servedate: "2025-06-18", slot: "09:00", status: "completed", service_name: "Full-Day Doggy Daycare", provider_name: "Happy Paws Co.", price: 40, pets: [mockPets[0]]},
//         { bookid: 3, servedate: "2025-07-20", slot: "14:00", status: "pending", service_name: "Cat Sitting (Basic)", provider_name: "Purrfect Sitters", price: 20, pets: [mockPets[1]] },
//         { bookid: 5, servedate: getCurrentDate(), slot: "11:00", status: "in-progress", service_name: "Professional Dog Grooming", provider_name: "Glamour Paws", price: 75, pets: [mockPets[1]]}
//     ],
//     statistics: {
//         totalAppointments: 4,
...
//         totalSpent: 40 + 75, // Only completed + in-progress for demo
//     },
//     filters: {}
// };

// const mockFullProviderProfile = {
//     ...mockProviderProfile,
//     statistics: {
//         totalServices: 5,
//         approvedServices: 4,
...
//         averageRating: 4.7,
//     },
//     services: mockServices.filter(s => s.providerid === 101 && s.status === 'approved'),
//     recentReviews: mockReviews.slice(0, 3)
// };

// // CORRECTED: This object now depends on `mockProviderRequests` and `mockServices`, so it's defined after them.
// const mockDetailedRequest = {
//     ...mockProviderRequests[0],
//     service_description: mockServices.find(s => s.name === mockProviderRequests[0].service_name)?.description,
//     customer_email: "johndoe@example.com",
//     customer_phone: "555-123-4567",
//     customer_address: "456 Pet Avenue, Dogtown",
//     hasConflicts: true,
//     conflicts: [
//         { bookid: 8, other_service_name: "Premium Dog Walking", other_status: "confirmed" }
//     ],
// };

// const mockDetailedRequest_NoConflict = {
//     ...mockProviderRequests[0],
//     service_description: mockServices.find(s => s.name === mockProviderRequests[0].service_name)?.description,
//     customer_email: "johndoe@example.com",
//     customer_phone: "555-123-4567",
...
// const mockProviderReviewStats = {
//     totalReviews: 3,
//     averageRating: 4.7,
//     serviceBreakdown: [
//         { serviceName: 'Premium Dog Walking', reviewCount: 2, averageRating: 4.5 },
//         { serviceName: 'Professional Dog Grooming', reviewCount: 1, averageRating: 5.0 },
//     ]
// };

// const mockProviderList = [
//     { userid: 101, name: "Happy Paws Co.", business_name: "Happy Paws Co.", description: "Top-notch walking and daycare.", address: "123 Park Ave, New York, NY", approved_service_count: 4, total_reviews: 3, average_rating: 4.7, logo: 'https://placehold.co/100x100/3498db/ffffff?text=HP' },
//     { userid: 102, name: "Purrfect Sitters", business_name: "Purrfect Sitters", description: "Your cat's home away from home.", address: "456 Main St, Anytown, USA", approved_service_count: 1, total_reviews: 0, average_rating: 0, logo: 'https://placehold.co/100x100/f39c12/ffffff?text=PS' },
//     { userid: 103, name: "Smart Pups Academy", business_name: "Smart Pups Academy", description: "Expert obedience and agility training.", address: "789 School Rd, Education City", approved_service_count: 1, total_reviews: 0, average_rating: 0, logo: 'https://placehold.co/100x100/9b59b6/ffffff?text=SP' },
//     { userid: 104, name: "Glamour Paws", business_name: "Glamour Paws", description: "Professional grooming with a gentle touch.", address: "101 Style St, Fashion City", approved_service_count: 1, total_reviews: 1, average_rating: 5, logo: 'https://placehold.co/100x100/e74c3c/ffffff?text=GP' },
// ];

// const mockServiceSummary = {
//     statistics: { total_services: 25, pending_count: 2, approved_count: 21, rejected_count: 2 },
//     recentReviews: [{ serviceid: 1, name: 'Premium Dog Walking', status: 'approved', provider_name: 'Happy Paws Co.' }],
//     providerBreakdown: [{ provider_name: 'Happy Paws Co.', total_services: 8, pending: 1, approved: 6, rejected: 1 }]
// };

// const mockReportSummary = {
//     totalReports: 2,
//     providerBreakdown: [{ provider_name: 'Happy Paws Co.', report_count: 2 }],
//     recentReports: mockReports.slice(0, 2)
// };
...
//                     user = { id: 1, name: 'Alex Johnson', email, role: 'Pet owner' };
//                 } else if (email.startsWith('provider')) {
//                     user = { id: 101, name: 'Happy Paws Co.', email, role: 'Service provider' };
//                 } else {
//                     user = { id: 1001, name: 'Admin User', email, role: 'Manager' };
//                 }
//                 resolve({ success: true, user, token: 'fake-jwt-token' });
//             }, MOCK_API_DELAY);
//         }),
//         startVerification: (formData) => new Promise(resolve => {
//             console.log('Starting verification with data:', formData);
//             // In a real app, you'd check if email exists here.
//             setTimeout(() => resolve({ success: true, sessionId: 'mock-session-12345', message: 'Verification code sent.' }), MOCK_API_DELAY);
//         }),

//         verifyRegistrationEmail: (sessionId, emailCode) => new Promise(resolve => {
//             console.log(`Verifying session ${sessionId} with code ${emailCode}`);
//             if (emailCode === '123456') { // Use a simple mock code
//                 setTimeout(() => resolve({ success: true, fullyVerified: true, message: 'Email verified successfully!' }), MOCK_API_DELAY);
//             } else {
//                 setTimeout(() => resolve({ success: false, error: 'Invalid verification code.' }), MOCK_API_DELAY);
//             }
//         }),

//         completeRegistration: (sessionId) => new Promise(resolve => {
//             console.log(`Completing registration for session ${sessionId}`);
//             // This mock simulates creating the user and returns the user object and a token
//             setTimeout(() => resolve({
//                 success: true,
//                 user: { id: 2, name: 'New User', email: 'new@test.com', role: 'Pet owner' },
//                 token: 'new-fake-jwt-token'
//             }), MOCK_API_DELAY);
//         }),

//         logout: () => new Promise(resolve => setTimeout(() => resolve({ success: true }), MOCK_API_DELAY)),
//         forgotPassword: (email) => new Promise(resolve => {
//             console.log(`Password reset requested for ${email}`);
//             setTimeout(() => resolve({ success: true, message: 'If an account exists, a reset code has been sent.' }), MOCK_API_DELAY);
//         }),
//         resetPassword: (data) => new Promise(resolve => {
//             console.log(`Resetting password for ${data.email} with code ${data.code}`);
//             if (data.code === '123456') { // Mocking a successful code
//                 setTimeout(() => resolve({ success: true, message: 'Password has been reset successfully.' }), MOCK_API_DELAY);
//             } else {
//                 setTimeout(() => resolve({ success: false, error: 'Invalid verification code.' }), MOCK_API_DELAY);
//             }
//         }),
//     },
//     profile: {
//         get: (role) => new Promise(resolve => setTimeout(() => {
//             if (role === 'Service provider') {
//                 resolve({ success: true, profile: mockProviderProfile });
//             } else {
//                 resolve({ success: true, profile: mockOwnerProfile });
//             }
//         }, MOCK_API_DELAY)),
//         update: (data) => new Promise(resolve => setTimeout(() => {
//             let profileToUpdate;
//             if (data.role === 'Service provider') {
//                 profileToUpdate = mockProviderProfile;
//             } else {
//                 profileToUpdate = mockOwnerProfile;
//             }
//             Object.assign(profileToUpdate, data);
//             resolve({ success: true, profile: profileToUpdate });
//         }, MOCK_API_DELAY)),
//         delete: () => new Promise(resolve => setTimeout(() => {
//             console.log("Account deletion requested.");
//             resolve({ success: true, message: "Account deleted successfully." });
//         }, MOCK_API_DELAY)),
//         getProviderProfile: (providerId) => new Promise(resolve => {
//             setTimeout(() => resolve({ success: true, profile: mockFullProviderProfile }), MOCK_API_DELAY);
//         }),
//         getProviders: (filters = {}) => new Promise(resolve => {
//             let filteredProviders = [...mockProviderList];

//             // Filter by general search query (q)
//             if (filters.q) {
...
//                 // This is a simplified mock. A real backend would join tables.
//                 // We'll just filter providers based on some mock logic.
//                 // For example, let's say only Happy Paws (101) and Glamour Paws (104) offer the first type.
//                 if (filters.typeids.includes(1)) {
//                     filteredProviders = filteredProviders.filter(p => p.userid === 101 || p.userid === 104);
//                 }
//             }

//             // Filter by price (This is also simplified for the mock)
//             if (filters.minPrice) {
//                 // Mock logic: assume cheaper providers are filtered out
//                 filteredProviders = filteredProviders.filter(p => p.userid !== 102);
//             }
//             if (filters.maxPrice && filters.maxPrice < 100) {
//                 // Mock logic: assume expensive providers are filtered out
//                 filteredProviders = filteredProviders.filter(p => p.userid !== 104);
//             }

//             // Sorting logic
//             if (filters.sortBy) {
//                 filteredProviders.sort((a, b) => {
//                     const fieldA = a[filters.sortBy === 'name' ? 'business_name' : 'average_rating'];
//                     const fieldB = b[filters.sortBy === 'name' ? 'business_name' : 'average_rating'];
...
//             setTimeout(() => resolve({ success: true, providers: filteredProviders }), MOCK_API_DELAY);
//         }),
//     },
//     pets: {
//         getById: (id) => new Promise(resolve => {
//             const pet = mockPets.find(p => p.petid === id);
//             if(pet) {
//                 resolve({ success: true, pet });
//             } else {
//                 resolve({ success: false, error: 'Pet not found'});
//             }
//         }),
//         getAll: () => new Promise(resolve => setTimeout(() => resolve({ success: true, pets: [...mockPets] }), MOCK_API_DELAY)),
//         create: (petData) => new Promise(resolve => {
//             setTimeout(() => {
//                 const newPet = { ...petData, petid: Date.now(), picture: `https://placehold.co/400x400/cccccc/ffffff?text=${encodeURIComponent(petData.name)}` };
//                 mockPets.push(newPet);
//                 mockDiets[newPet.petid] = [];
//                 mockActivities[newPet.petid] = [];
//                 resolve({ success: true, pet: newPet });
//             }, MOCK_API_DELAY);
//         }),
//         update: (petId, petData) => new Promise(resolve => {
//             setTimeout(() => {
//                 const index = mockPets.findIndex(p => p.petid === petId);
//                 if (index !== -1) {
//                     mockPets[index] = { ...mockPets[index], ...petData };
//                     resolve({ success: true, pet: mockPets[index] });
//                 } else {
//                     resolve({ success: false, error: 'Pet not found' });
//                 }
//             }, MOCK_API_DELAY);
//         }),
//         delete: (petId) => new Promise(resolve => {
//             setTimeout(() => {
//                 mockPets = mockPets.filter(p => p.petid !== petId);
//                 delete mockDiets[petId];
//                 delete mockActivities[petId];
//                 resolve({ success: true });
//             }, MOCK_API_DELAY);
//         })
//     },
//     diet: {
//         getForPet: (petId) => new Promise(resolve => setTimeout(() => {
//             resolve({ success: true, diet: mockDiets[petId] || [] });
//         }, MOCK_API_DELAY)),
//         add: (petId, dietData) => new Promise(resolve => setTimeout(() => {
//             if(!mockDiets[petId]) mockDiets[petId] = [];
//             const [hour, minute] = dietData.time.split(':');
//             const newDiet = {
//                 ...dietData,
//                 id: Date.now(),
//                 petid: petId,
//                 hour,
//                 minute,
//                 enddate: dietData.enddate || null
//             };
//             mockDiets[petId].push(newDiet);
//             resolve({ success: true, diet: newDiet });
//         }, MOCK_API_DELAY)),
//         update: (petId, dietId, dietData) => new Promise(resolve => setTimeout(() => {
//             if (!mockDiets[petId]) {
//                 return resolve({ success: false, error: 'Pet not found'});
//             }
//             const dietIndex = mockDiets[petId].findIndex(d => d.id === dietId);
//             if (dietIndex === -1) {
//                 return resolve({ success: false, error: 'Diet item not found'});
//             }
//             const [hour, minute] = dietData.time.split(':');
//             mockDiets[petId][dietIndex] = {
//                 ...mockDiets[petId][dietIndex],
//                 ...dietData,
//                 hour,
//                 minute,
//                 enddate: dietData.enddate || null
//             };
//             resolve({ success: true, diet: mockDiets[petId][dietIndex] });
//         }, MOCK_API_DELAY)),
//         delete: (petId, dietId) => new Promise(resolve => setTimeout(() => {
//             if (!mockDiets[petId]) {
//                 return resolve({ success: false, error: 'Pet not found'});
//             }
//             mockDiets[petId] = mockDiets[petId].filter(d => d.id !== dietId);
//             resolve({ success: true });
//         }, MOCK_API_DELAY)),
//         getForUser: () => new Promise(resolve => {
//             setTimeout(() => {
//                 const dietPlans = mockPets.map(pet => {
//                     return {
//                         petId: pet.petid,
//                         petName: pet.name,
//                         diets: mockDiets[pet.petid] || []
//                     }
//                 }).filter(plan => plan.diets.length > 0);
//                 resolve({ success: true, dietPlans });
//             }, MOCK_API_DELAY);
//         }),
//     },
//     activity: {
//         getForPet: (petId) => new Promise(resolve => setTimeout(() => {
//             resolve({ success: true, activities: mockActivities[petId] || [] });
//         }, MOCK_API_DELAY)),
//         add: (petId, activityData) => new Promise(resolve => setTimeout(() => {
//             if(!mockActivities[petId]) mockActivities[petId] = [];
//             const newActivity = {
//                 ...activityData,
//                 id: Date.now(),
//                 petid: petId,
//                 startdate: activityData.date, // Use 'date' as 'startdate'
//                 enddate: activityData.enddate || null
//             };
//             mockActivities[petId].push(newActivity);
//             resolve({ success: true, activity: newActivity });
//         }, MOCK_API_DELAY)),
//         update: (petId, activityId, activityData) => new Promise(resolve => setTimeout(() => {
//             if (!mockActivities[petId]) {
//                 return resolve({ success: false, error: 'Pet not found'});
//             }
//             const activityIndex = mockActivities[petId].findIndex(a => a.id === activityId);
//             if (activityIndex === -1) {
//                 return resolve({ success: false, error: 'Activity item not found'});
//             }
//             mockActivities[petId][activityIndex] = {
//                 ...mockActivities[petId][activityIndex],
//                 ...activityData,
//                 startdate: activityData.date, // Use 'date' as 'startdate'
//                 enddate: activityData.enddate || null
//             };
//             resolve({ success: true, activity: mockActivities[petId][activityIndex] });
//         }, MOCK_API_DELAY)),
//         delete: (petId, activityId) => new Promise(resolve => setTimeout(() => {
//             if (!mockActivities[petId]) {
//                 return resolve({ success: false, error: 'Pet not found'});
//             }
//             mockActivities[petId] = mockActivities[petId].filter(a => a.id !== activityId);
//             resolve({ success: true });
//         }, MOCK_API_DELAY)),
//         getAllForUser: () => new Promise(resolve => {
//             setTimeout(() => {
//                 const userPets = mockPets.filter(p => p.userid === 1);
//                 const userPetIds = userPets.map(p => p.petid);
//                 let allActivities = [];
//                 userPetIds.forEach(id => {
//                     if (mockActivities[id]) {
//                         allActivities = [...allActivities, ...mockActivities[id]];
//                     }
//                 });
...
//             setTimeout(() => {
//                 const userPetIds = mockPets.map(p => p.petid);
//                 const personalSchedule = [];

//                 userPetIds.forEach(petId => {
//                     if (mockDiets[petId]) {
//                         mockDiets[petId].forEach(diet => {
//                             if (diet.addToCalendar) {
//                                 personalSchedule.push({
//                                     ...diet,
//                                     id: `d-${diet.id}`, // FIX: Ensure key is unique
//                                     type: 'diet',
//                                     title: diet.food_name,
//                                     time: `${diet.hour}:${diet.minute}`,
//                                     petName: mockPets.find(p=>p.petid === petId)?.name || '',
//                                 });
//                             }
//                         });
//                     }
//                     if (mockActivities[petId]) {
//                         mockActivities[petId].forEach(activity => {
//                             if (activity.addToCalendar) {
//                                 personalSchedule.push({
//                                     ...activity,
//                                     id: `a-${activity.id}`, // FIX: Ensure key is unique
//                                     type: 'activity',
...
//                     }
//                 });
//                 resolve({ success: true, schedule: personalSchedule });
//             }, MOCK_API_DELAY);
//         })
//     },
//     scheduleDashboard: {
//         getForOwner: () => new Promise(resolve => {
//             setTimeout(() => resolve({ success: true, dashboard: mockScheduleDashboard }), MOCK_API_DELAY);
//         }),

//         getForProvider: (filters = {}) => new Promise(resolve => {
//             setTimeout(() => resolve({ success: true, dashboard: mockProviderDashboard }), MOCK_API_DELAY);
//         }),
//     },
//     bookings: {
//         getForOwner: () => new Promise(resolve => {
//             const bookingsWithServices = mockBookings.map(booking => {
//                 const service = mockServices.find(s => s.serviceid === booking.serviceid);
//                 return { ...booking, service_name: service.name, provider_name: service.provider_name, price: service.price };
//             });
//             setTimeout(() => resolve({ success: true, bookings: bookingsWithServices }), MOCK_API_DELAY);
//         }),
//         create: (bookingData) => new Promise(resolve => {
//             setTimeout(() => {
//                 const service = mockServices.find(s => s.serviceid === bookingData.serviceid);
//                 if (!service) {
//                     return resolve({ success: false, error: 'Service not found'});
//                 }
//                 const selectedPets = mockPets.filter(p => bookingData.petids.includes(p.petid));
//                 const newBooking = {
//                     serviceid: bookingData.serviceid,
//                     servedate: bookingData.servedate,
...
//                 mockProviderRequests.unshift({
//                     bookid: newBooking.bookid,
//                     servedate: newBooking.servedate,
//                     slot: newBooking.slot,
//                     status: "pending",
//                     service_name: service.name,
//                     pet_owner_name: "Alex Johnson", // Mock current user name
//                     pets: selectedPets
//                 })
//                 resolve({ success: true, booking: newBooking });
//             }, MOCK_API_DELAY)
//         }),
//         getById: (id) => new Promise(resolve => setTimeout(() => {
//             const bookingData = mockBookings.find(b => b.bookid === id);
//             if (bookingData) {
//                 const serviceData = mockServices.find(s => s.serviceid === bookingData.serviceid);
//                 const hasReviewed = mockReviews.some(r => r.userid === bookingData.userid && r.serviceid === bookingData.serviceid);

//                 let bookingPets = bookingData.pets;
//                 if (!bookingPets && bookingData.petids) {
//                     bookingPets = mockPets.filter(p => bookingData.petids.includes(p.petid));
//                 }
...
//                 resolve({ success: true, booking: finalBooking });
//             } else {
//                 resolve({ success: false, error: "Booking not found" });
//             }
//         }, MOCK_API_DELAY)),
//         getForProvider: () => new Promise(resolve => setTimeout(() => resolve({ success: true, bookings: mockProviderRequests }), MOCK_API_DELAY)),
//         getChatUpdates: (bookingId) => new Promise(resolve => setTimeout(() => resolve({ success: true, updates: mockChatUpdates[bookingId] || [] }), MOCK_API_DELAY)),
//         getRequestDetails: (bookingId) => new Promise(resolve => {
//             const request = mockProviderRequests.find(r => r.bookid === bookingId);
//             if (request) {
//                 // UPDATED: Now returns the non-conflicted version
//                 resolve({ success: true, booking: mockDetailedRequest_NoConflict });
//             } else {
//                 resolve({ success: false, error: "Request not found" });
//             }
//         }),
//         updateStatus: (bookingId, status) => new Promise(resolve => setTimeout(() => {
//             const index = mockProviderRequests.findIndex(b => b.bookid === bookingId);
//             if (index > -1) {
//                 mockProviderRequests[index].status = status;
//                 if(status !== 'pending') {
//                     mockProviderRequests = mockProviderRequests.filter(b => b.bookid !== bookingId)
//                 }
//             }
//             resolve({success: true});
//         }, MOCK_API_DELAY)),
//         cancel: (bookingId) => new Promise(resolve => {
//             setTimeout(() => {
//                 const bookingIndex = mockBookings.findIndex(b => b.bookid === bookingId);
//                 if (bookingIndex !== -1) {
//                     if (mockBookings[bookingIndex].status === 'completed' || mockBookings[bookingIndex].status === 'cancelled') {
//                         resolve({ success: false, error: 'Booking cannot be cancelled.' });
//                     } else {
//                         mockBookings[bookingIndex].status = 'cancelled';
//                         resolve({ success: true, booking: mockBookings[bookingIndex] });
//                     }
//                 } else {
//                     resolve({ success: false, error: 'Booking not found.' });
//                 }
//             }, MOCK_API_DELAY);
//         }),
//         getForManager: (bookingId) => new Promise(resolve => {
//             const booking = mockBookings.find(b => b.bookid === bookingId);
//             const service = mockServices.find(s => s.serviceid === booking?.serviceid);
//             if (booking && service) {
//                 const fullBookingDetails = { ...booking, service: service, owner: mockOwnerProfile };
//                 resolve({ success: true, booking: fullBookingDetails });
//             } else {
//                 resolve({ success: false, error: "Booking not found" });
//             }
//         }),
//         getForProviderById: (bookingId) => new Promise(resolve => {
//             const booking = mockBookings.find(b => b.bookid === bookingId);
//             if (booking) {
//                 const service = mockServices.find(s => s.serviceid === booking.serviceid);
//                 const owner = mockOwnerProfile; // In a real app, you'd fetch this based on booking.userid
//                 const detailedBooking = { ...booking, service, owner, pets: booking.pets || [] };
//                 resolve({ success: true, booking: detailedBooking });
//             } else {
//                 resolve({ success: false, error: "Booking not found" });
//             }
//         }),
//     },
//     reviews: {
//         getForService: (serviceId) => new Promise(resolve => setTimeout(() => {
//             const reviews = mockReviews.filter(r => r.serviceid === serviceId);
//             resolve({ success: true, reviews });
//         }, MOCK_API_DELAY)),
//         add: (serviceId, userId, userName, reviewData) => new Promise(resolve => {
//             setTimeout(() => {
//                 const newReview = {
//                     id: Date.now(),
//                     serviceid: serviceId,
...
//         update: (reviewId, reviewData) => new Promise(resolve => {
//             setTimeout(() => {
//                 const index = mockReviews.findIndex(r => r.id === reviewId);
//                 if (index !== -1) {
//                     mockReviews[index] = { ...mockReviews[index], stars: reviewData.rating, comment: reviewData.comment };
//                     resolve({ success: true, review: mockReviews[index] });
//                 } else {
//                     resolve({ success: false, error: 'Review not found' });
//                 }
//             }, MOCK_API_DELAY);
//         }),
//         // ADDED: delete method
//         delete: (reviewId) => new Promise(resolve => {
//             setTimeout(() => {
...
//             }, MOCK_API_DELAY);
//         }),
//         getForProvider: (providerId) => new Promise(resolve => {
//             const providerReviews = mockReviews.filter(r => r.serviceid === 1 || r.serviceid === 5); // Simulate getting reviews for provider 101's services
//             resolve({ success: true, reviews: providerReviews, statistics: mockProviderReviewStats });
//         })
//     },
//     reports: {
//         create: (reportData) => new Promise(resolve => setTimeout(() => {
//             console.log("Submitting report:", reportData);
//             resolve({ success: true, message: "Report submitted successfully." });
//         }, MOCK_API_DELAY)),
//         getForProvider: (providerId) => new Promise(resolve => {
//             setTimeout(() => {
//                 const providerReports = mockReports.filter(r => r.provider_name === "Happy Paws Co."); // Mocking for provider 101
//                 resolve({ success: true, reports: providerReports });
//             }, MOCK_API_DELAY);
//         }),
//         getSummary: () => new Promise(resolve => setTimeout(() => resolve({ success: true, summary: mockReportSummary }), MOCK_API_DELAY)),
//     },
//     services: {
//         getById: (id) => new Promise(resolve => setTimeout(() => {
//             const service = mockServices.find(s => s.serviceid === id);
//             if(service) {
...
//                 resolve({ success: true, services: providerServices });
//             }, MOCK_API_DELAY);
//         }),
//         create: (serviceData) => new Promise(resolve => {
//             setTimeout(() => {
//                 const newService = { ...serviceData, serviceid: Date.now(), providerid: 101, provider_name: "Happy Paws Co.", status: 'pending_approval' }; // Example provider
//                 mockServices.push(newService);
//                 resolve({ success: true, service: newService });
//             }, MOCK_API_DELAY);
//         }),
//         update: (serviceId, serviceData) => new Promise(resolve => setTimeout(() => {
//             const index = mockServices.findIndex(s => s.serviceid === serviceId);
//             if (index !== -1 && mockServices[index].status === 'pending') {
//                 mockServices[index] = { ...mockServices[index], ...serviceData, status: 'pending' };
//                 resolve({ success: true, service: mockServices[index] });
//             } else {
//                 resolve({ success: false, error: 'Service not found or is not pending.' });
//             }
//         }, MOCK_API_DELAY)),

//         updateApproved: (serviceId, serviceData) => new Promise(resolve => setTimeout(() => {
//             const index = mockServices.findIndex(s => s.serviceid === serviceId);
//             if (index !== -1 && mockServices[index].status === 'approved') {
//                 // Only allows updating description and timeslots, as per backend
//                 mockServices[index].description = serviceData.description;
//                 mockServices[index].timeslots = serviceData.timeSlots;
//                 resolve({ success: true, service: mockServices[index] });
//             } else {
//                 resolve({ success: false, error: 'Service not found or is not approved.' });
//             }
//         }, MOCK_API_DELAY)),

//         delete: (serviceId) => new Promise(resolve => {
//             setTimeout(() => {
//                 mockServices = mockServices.filter(s => s.serviceid !== serviceId);
//                 resolve({ success: true });
//             }, MOCK_API_DELAY);
//         }),
//         search: (params) => new Promise(resolve => setTimeout(() => {
//             let results = mockServices.filter(s => s.status === 'approved');
//             if (params.q) {
//                 results = results.filter(s =>
//                     s.name.toLowerCase().includes(params.q.toLowerCase()) ||
//                     s.provider_name.toLowerCase().includes(params.q.toLowerCase()) ||
...
//                 results = results.filter(s => params.typeids.includes(s.typeid));
//             }
...
//             resolve({ success: true, services: results });
//         }, MOCK_API_DELAY)),

//         getPending: () => new Promise(resolve => setTimeout(() => resolve({ success: true, services: mockPendingServices }), MOCK_API_DELAY)),
//         approve: (serviceId) => new Promise(resolve => setTimeout(() => resolve({ success: true, message: 'Service approved' }), MOCK_API_DELAY)),
//         reject: (serviceId, reason) => new Promise(resolve => setTimeout(() => resolve({ success: true, message: 'Service rejected' }), MOCK_API_DELAY)),

//         getTypes: () => new Promise(resolve => setTimeout(() => {
//             resolve({ success: true, serviceTypes: mockServiceTypes });
//         }, MOCK_API_DELAY)),
//         getReviewSummary: () => new Promise(resolve => setTimeout(() => resolve({ success: true, summary: mockServiceSummary }), MOCK_API_DELAY)),
//         getByIdForManager: (serviceId) => new Promise(resolve => {
//             const service = mockServices.find(s => s.serviceid === serviceId);
//             if (service) {
//                 const provider = mockProviderList.find(p => p.userid === service.providerid);
//                 // Combine service with provider details for a full overview
//                 const detailedService = { ...service, provider };
//                 resolve({ success: true, service: detailedService });
//             } else {
//                 resolve({ success: false, error: "Service not found" });
//             }
//         }),
//     },
//     helpdesk: {
//         create: (ticketData, user) => new Promise(resolve => setTimeout(() => {
//             const newTicket = {
//                 ...ticketData,
//                 id: Date.now(),
//                 status: 'open',
...
//         }, MOCK_API_DELAY)),
//         getForUser: (userId) => new Promise(resolve => setTimeout(() => {
//             const tickets = mockTickets.filter(t => t.userId === userId);
//             resolve({ success: true, tickets });
//         }, MOCK_API_DELAY)),
//         getAll: () => new Promise(resolve => setTimeout(() => {
//             const sortedTickets = [...mockTickets].sort((a, b) => {
//                 if (a.status === 'open' && b.status !== 'open') return -1;
//                 if (a.status !== 'open' && b.status === 'open') return 1;
//                 return new Date(b.date) - new Date(a.date);
//             });
//             resolve({ success: true, tickets: sortedTickets });
//         }, MOCK_API_DELAY)),
//         updateStatus: (ticketId, status) => new Promise(resolve => setTimeout(() => {
...
//             }
//         }, MOCK_API_DELAY)),
//         getReplies: (ticketId) => new Promise(resolve => {
//             setTimeout(() => {
//                 resolve({ success: true, replies: mockTicketReplies[ticketId] || [] });
//             }, MOCK_API_DELAY);
//         }),
//         addManagerReply: (ticketId, message, user) => new Promise(resolve => {
//             if (!mockTicketReplies[ticketId]) {
//                 mockTicketReplies[ticketId] = [];
//             }
//             const newReply = {
//                 replyid: Date.now(),
//                 userid: user.id,
...
//             };
//             mockTicketReplies[ticketId].push(newReply);
//             resolve({ success: true, reply: newReply });
//         }),
//         addUserReply: (ticketId, message, user) => new Promise(resolve => {
//             if (!mockTicketReplies[ticketId]) {
//                 mockTicketReplies[ticketId] = [];
//             }
//             const newReply = {
//                 replyid: Date.now(),
//                 userid: user.id,
//                 role: user.role, // Use the user's actual role
//                 message: message,
//                 created_at: new Date().toISOString()
//             };
//             mockTicketReplies[ticketId].push(newReply);
...
//     },
//     notifications: {
//         getStats: () => new Promise(resolve => setTimeout(() => {
//             const unread = mockNotifications.filter(n => n.read_status === 0).length;
//             resolve({ success: true, stats: { unread, total: mockNotifications.length } });
//         }, MOCK_API_DELAY)),
//         getAll: (params = { page: 1, limit: 10 }) => new Promise(resolve => setTimeout(() => {
//             const sorted = [...mockNotifications].sort((a,b) => new Date(b.created_at) - new Date(a.created_at));
//             resolve({ success: true, notifications: sorted, pagination: { total: sorted.length, page: 1, limit: 10, totalPages: 1 } });
//         }, MOCK_API_DELAY)),
//         markAsRead: (id) => new Promise(resolve => setTimeout(() => {
//             const notif = mockNotifications.find(n => n.notiid === id);
//             if (notif) notif.read_status = 1;
//             resolve({ success: true });
//         }, MOCK_API_DELAY)),
//         markAllAsRead: () => new Promise(resolve => setTimeout(() => {
//             mockNotifications.forEach(n => n.read_status = 1);
//             resolve({ success: true, updatedCount: mockNotifications.filter(n => n.read_status === 1).length });
//         }, MOCK_API_DELAY)),
//         delete: (id) => new Promise(resolve => setTimeout(() => {
//             mockNotifications = mockNotifications.filter(n => n.notiid !== id);
//             resolve({ success: true });
//         }, MOCK_API_DELAY)),
//     },
//     chat: {
//         getConversations: (user) => new Promise(resolve => setTimeout(() => { // MODIFIED: Added user param
//             let relevantBookings = [];

//             if (user.role === 'Service provider') {
//                 // If user is a provider, find all services they offer
//                 const providerServiceIds = mockServices
//                     .filter(s => s.providerid === user.id)
//                     .map(s => s.serviceid);
//                 // Then, find all bookings for those services
//                 relevantBookings = mockBookings.filter(b => providerServiceIds.includes(b.serviceid));
//             } else { // Assumes Pet owner
//                 // If user is an owner, find all their bookings
//                 relevantBookings = mockBookings.filter(b => b.userid === user.id);
//             }

//             const conversations = relevantBookings.map(b => {
//                 const service = mockServices.find(s => s.serviceid === b.serviceid);
//                 // Find the owner's name from the mock profile
//                 const owner = mockOwnerProfile; // In a real app, you'd look this up
//                 return {
//                     bookid: b.bookid,
//                     status: b.status,
//                     service_name: service.name,
//                     provider_name: service.provider_name,
//                     owner_name: owner.name, // Use the looked-up owner name
//                     last_message_timestamp: "2025-06-23T12:00:00Z", // Mocked for now
//                     message_count: mockChatUpdates[b.bookid]?.length || 0,
//                 };
//             });
//             resolve({ success: true, conversations });
//         }, MOCK_API_DELAY)),
//         getChatUpdates: (bookingId) => new Promise(resolve => setTimeout(() => {
//             // Ensure messages have the no_update ID
//             const updates = (mockChatUpdates[bookingId] || []).map((msg, index) => ({...msg, no_update: index + 1}));
//             resolve({ success: true, updates });
//         }, MOCK_API_DELAY)),

//         getMessageImage: (bookingId, updateNumber) => new Promise(resolve => {
//             setTimeout(() => {
//                 resolve({ success: true, image: MOCK_BASE64_IMAGE, content_type: 'image/png' });
//             }, MOCK_API_DELAY);
//         }),

//         sendMessage: (bookingId, messageText, user) => new Promise(resolve => setTimeout(() => {
//             if (!mockChatUpdates[bookingId]) {
//                 mockChatUpdates[bookingId] = [];
//             }
//             // CORRECTED: Set sender based on the current user's role
//             const senderType = user.role === 'Pet owner' ? 'owner' : 'provider';
//             const newMessage = { from: senderType, text: messageText, timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) };
//             mockChatUpdates[bookingId].push(newMessage);
//             resolve({ success: true, update: newMessage });
//         }, MOCK_API_DELAY))
//     }
// };
...
const API_BASE_URL = 'https://localhost:8443/api'; // Ensure this matches your backend server address
...
const LoginPage = ({ setPage }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!res.success) {
            // UPDATED: Check for the specific verification error
                ...
                <div>
                    ...
                    {isCreating ? (
                        <>
                            ...
                            {licensePreview && (
                                <div className="mt-4">
                                    <img src={licensePreview} alt="License preview" className="max-h-40 rounded-lg" />
                                </div>
                            )}
                        </>
                    ) : (
                        <>
                            ...
                            {formData.license && (
                                <div className="mt-2">
                                    <img src={formData.license} alt="License" className="max-h-40 rounded-lg" />
                                </div>
                            )}
                        </>
                    )}
...
const MyServicesPage = ({}) => {
    ...
    if (!selectedService && submissionData.service_type && !submissionData.typeid) {
    ...
    if (selectedService) {
        if (selectedService.status === 'approved') {
            await api.services.updateApproved(selectedService.serviceid, submissionData);
        } else {
            // This assumes you have an `update` method in your api service
            await api.services.update(selectedService.serviceid, submissionData);
        }
    } else {
        await api.services.create(submissionData);
    }
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            <div className="flex justify-between items-center mb-6">
                ...
                <Button onClick={handleAdd} className="flex items-center gap-2"><PlusCircle size={16} /> Add Service</Button>
            </div>
...
const ProfilePage = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            if (!user) return;
            setLoading(true);
            const res = await api.profile.get(user.role);
